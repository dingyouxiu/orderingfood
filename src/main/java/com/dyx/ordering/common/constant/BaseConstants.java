...
public final class BaseConstants {
    ...
    /**
     * set ID for multi databases, default is id, when use kingbase, need to set it to ID
     */
    ...
    public static final String DEP_ALL_TASK_CODE = "0";

    public static final String CMD_PARAM_SUB_PROCESS_PARENT_INSTANCE_ID = "parentProcessInstanceId";
    public static final String CMD_PARAM_SUB_PROCESS_PARENT_TASK_INSTANCE_ID = "parentTaskInstanceId";
    ...
    public static final String SUB_PROCESS_DEFINE_CODE = "processDefinitionCode";
    ...
    public static final String SPECIAL_DATABASE = "specialDatabase";
    ...
    public static final String DATA_QUALITY_SUPPORT_DATASOURCE = "data-quality.support.datasources";
    // Add as requirement, to avoid upgrade but forget apply latest common.properties
    public static final String DATA_QUALITY_SUPPORT_DATASOURCE_DEFAULT =
            "JDBC-Redshift,JDBC-Mysql,JDBC-TiDB,JDBC-Postgres,JDBC-ClickHouse,JDBC-SQLServer,JDBC-Oracle";

    public static final String SEATUNNEL_TRANSFORMS_JAR_PATH = "seatunnel.transforms.jar.path";

    public static final String SYNC_TASK_SUBMIT_SCRIPT_NAME = "sync.task.submit.script.name";

    public static final String SYNC_TASK_GET_ENGINE_ID_RETRY_TIMES = "sync.task.get.engine.id.retry.times";
     ...
     * resource
     */
    public static final int EMPTY_RESOURCE_PID = -1;
