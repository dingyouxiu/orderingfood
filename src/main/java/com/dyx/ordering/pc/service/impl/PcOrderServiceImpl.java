...
import com.dyx.ordering.pc.mapper.PcOrderMapper;
...
@Service
public class PcOrderServiceImpl extends BaseOrderServiceImpl implements PcOrderService {
    private final ReentrantLock reentrantLock = new ReentrantLock();

    @Autowired
    private PcOrderFoodService wechatOrderFoodService;

    @Autowired
    private PlatformTransactionManager transactionManager;

    @Autowired
    private PcOrderMapper wechatOrderMapper;
     ...
     */
    @Override
    public IPage<OrderDTO> queryPage(PcOrderQuery orderQuery) {
    ...
    private void addOnsUpdateOrder(OrderDTO orderDTO){
        ...
        // 查询订单中已存在商品
        PcOrderFoodQuery wechatOrderFoodQuery =
                PcOrderFoodQuery.builder()
    ...
    private LambdaQueryWrapper<OrderEntity> buildQueryWrapper(PcOrderQuery query){
