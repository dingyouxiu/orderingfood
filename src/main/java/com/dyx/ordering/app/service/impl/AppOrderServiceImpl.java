...
import com.dyx.ordering.app.mapper.AppOrderMapper;
import com.dyx.ordering.app.query.AppOrderFoodQuery;
import com.dyx.ordering.app.query.AppOrderQuery;
import com.dyx.ordering.app.service.AppOrderFoodService;
...
public class AppOrderServiceImpl implements AppOrderService {
    ...
    @Autowired
    private AppOrderMapper wechatOrderMapper;
    ...
    private void addOnsUpdateOrder(OrderDTO orderDTO){
        ...
        // 查询订单中已存在商品
        AppOrderFoodQuery wechatOrderFoodQuery =
                AppOrderFoodQuery.builder()
    ...
    private LambdaQueryWrapper<OrderEntity> buildQueryWrapper(AppOrderQuery query){
