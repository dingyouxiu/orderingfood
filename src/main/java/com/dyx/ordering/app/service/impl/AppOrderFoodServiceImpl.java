...
@Service
public class AppOrderFoodServiceImpl extends BaseOrderFoodServiceImpl implements AppOrderFoodService {
    ...
    private LambdaQueryWrapper<OrderFoodEntity> buildQueryWrapper(AppOrderFoodQuery query){
